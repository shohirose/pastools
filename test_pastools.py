...
def test_parse_url():
    url = 'pbscp://host1/home/user1/test1.sh'
...
def test_parse_export_env():
    env = 'HOME=/home/user1,MYVAR=1,PAS_PRIMARY_FILE=pbscp://host1/home/user1/test1.sh'
...
def test_add_access_env_vars():
    env = 'HOME=/home/user1,MYVAR=1,PAS_PRIMARY_FILE=pbscp://host1/home/user1/test1.sh'
    new_env = pastools.add_access_env_vars(env)
    assert new_env == 'HOME=/home/user1,MYVAR=1,PAS_PRIMARY_FILE=pbscp://host1/home/user1/test1.sh' + \
        ',ACCESS_INPUT_FILES=test1.sh@host1:/home/user1/test1.sh' + \
        ',ACCESS_OUTPUT_FILES=*@host1:/home/user1' + \
        ',ACCESS_RUNNING_FILES=/home/user1'
